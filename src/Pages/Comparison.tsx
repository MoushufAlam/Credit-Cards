...
import { setUserData } from '../features/userSlice' // or wherever it's stored
...
function Comparison() {
  ...
  const selectedIds = useSelector((state: RootState) => state.user.compareList)
  ...
  return (
    <div className="container py-5 mt-3">
      ...
      <div className="d-flex overflow-auto gap-4 mt-4 pb-3">
        {selectedCards.map((card) => (
          <div key={card.id} className="flex-shrink-0" style={{ width: '300px' }}>
